...
const Demo3 = () => {
  ...
  return (
    <div className="demo-section hooks-demo-3">
      ...
      <p>This effect sets up an interval to console log every 500ms. Open up your browser's JavaScript console to
        see the logs.</p>
      <p>Navigate away from this page using the Home button at the top-right of your screen.</p>
      <p>This component will unmount, and the cleanup will be performed so that the interval is cleared and no
        longer console logs.</p>
    </div>
  );
}
